...
def generate_labels_one_target(unlabeled_dataframe, ip_dst_column, victim_ip):
    ...
    unlabeled_dataframe.loc[(unlabeled_dataframe[ip_dst_column] == victim_ip), "Assigned_Label"] = 1
...
def generate_labels_src_to_dst(unlabeled_df, ip_src_col, ip_dst_col, attacker, victim):
    ...
    unlabeled_df.loc[(unlabeled_df[ip_src_col] == attacker) & (unlabeled_df[ip_dst_col] == victim), "Assigned_Label"] = 1