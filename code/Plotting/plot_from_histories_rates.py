...
def calc_fnr_on_epochs(np_shape_fn, np_shape_tp, epochs):
    ...
    for i in range(epochs):
        ...
        column_list.append(fn_val_in_epoch_i /
                           (fn_val_in_epoch_i + tp_val_in_epoch_i))
...
def calc_fpr_on_epochs(np_shape_fp, np_shape_tn, epochs):
    ...
    for i in range(epochs):
        ...
        list.append(fp_val_in_epoch_i /
                    (fp_val_in_epoch_i + tp_val_in_epoch_i))
...
np_fnr = calc_fnr_on_epochs(
    np_shape_of_histories_FN, np_shape_of_histories_TP, 100)
...
plt.fill_between(x_axis, min1, max1, facecolor='orange',
                 label="Min/Max Shading", alpha=0.4)
...
np_fpr = calc_fpr_on_epochs(
    np_shape_of_histories_FP, np_shape_of_histories_TN, 100)
...
plt.savefig(str(PATH_TO_HISTORIES) + "historyMultipleRates.png",
