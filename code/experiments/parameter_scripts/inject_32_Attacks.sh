...
ATTACK_START_TIMESTAMP=$4
AMMOUNT_ATTACKS=$5
AMMOUNT_ATTACKS_PER_IP=$6
Start_Port=$7
End_Port=$8
#End_Port=65535
IP_DST_VICTIM=$9
...
python3 ../Data/Label_Generator/ONE_TARGET_LABEL.py $IP_DST_VICTIM $OUT_CSV $LABELD_OUT_CSV
...
cp parameter_scripts/inject_32_Attacks.sh "$OUTPUT_FOLDER_PATH/"
